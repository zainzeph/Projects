    ...
    if time_elapsed > 1./frame_rate:
        ...
        if not np.any(faces):
            ...
            if (confidence > 8)and(id > 0):    
                        ...
                        if (YP < -10):
                            BackY = BackY - (abs(int(YP*JumpV/2)))
            ...
            cv2.putText(img, str(BackY), (x+50,y-50), font, 1, (255,255,255), 2)
